...
function Schedule() {
    React.useEffect(() => {
        document.getElementsByClassName('schedule-page-title')[0].addEventListener('mouseover', function (e) {
            ...
            document.getElementsByClassName('schedule-page-title')[0].style.textShadow = "(" + rYP / 10 + 'px ' + rXP / 80 + 'px rgba(227,6,19,.8), ' + rYP / 8 + 'px ' + rXP / 60 + 'px rgba(255,237,0,1), ' + rXP / 70 + 'px ' + rYP / 12 + 'px rgba(0,159,227,.7))';
        });
        ...
        function loop1() {
            ...
            lines1.map(line => { return line.step(); });
        }
        function Line1() {
            this.reset();
        }
        ...
        Line1.prototype.reset = function () {
            ...
            this.lightInputMultiplier = opts1.baseLightInputMultiplier + opts1.addedLightInputMultiplier * Math.random();
        ...
        Line1.prototype.beginPhase = function () {
            ...
            this.rad += baseRad1 * (Math.random() < .5 ? 1 : -1);
            this.addedX = Math.cos(this.rad);
            this.addedY = Math.sin(this.rad);

            if (Math.random() < opts1.dieChance || this.x > dieX1 || this.x < -dieX1 || this.y > dieY1 || this.y < -dieY1)
                this.reset();
        }
        ...
        Line1.prototype.step = function () {
            ...
            ctx1.fillStyle = ctx1.shadowColor = this.color.replace('light', opts1.baseLight + opts1.addedLight * Math.sin(this.cumulativeTime * this.lightInputMultiplier));
            ctx1.fillRect(opts1.cx + (this.x + x) * opts1.len, opts1.cy + (this.y + y) * opts1.len, 2, 2);

            if (Math.random() < opts1.sparkChance)
                ctx1.fillRect(opts1.cx + (this.x + x) * opts1.len + Math.random() * opts1.sparkDist * (Math.random() < .5 ? 1 : -1) - opts1.sparkSize / 2, opts1.cy + (this.y + y) * opts1.len + Math.random() * opts1.sparkDist * (Math.random() < .5 ? 1 : -1) - opts1.sparkSize / 2, opts1.sparkSize, opts1.sparkSize)
        }
        loop1();
        ...
        function loop2() {
            ...
            lines2.map(line => { return line.step(); });
        }
        function Line2() {
            this.reset();
        }
        ...
        Line2.prototype.reset = function () {
            ...
            this.lightInputMultiplier = opts2.baseLightInputMultiplier + opts2.addedLightInputMultiplier * Math.random();
        ...
        Line2.prototype.beginPhase = function () {
            ...
            this.rad += baseRad2 * (Math.random() < .5 ? 1 : -1);
            this.addedX = Math.cos(this.rad);
            this.addedY = Math.sin(this.rad);

            if (Math.random() < opts2.dieChance || this.x > dieX2 || this.x < -dieX2 || this.y > dieY2 || this.y < -dieY2)
                this.reset();
        }
        ...
        Line2.prototype.step = function () {
            ...
            ctx2.fillStyle = ctx2.shadowColor = this.color.replace('light', opts2.baseLight + opts2.addedLight * Math.sin(this.cumulativeTime * this.lightInputMultiplier));
            ctx2.fillRect(opts2.cx + (this.x + x) * opts2.len, opts2.cy + (this.y + y) * opts2.len, 2, 2);

            if (Math.random() < opts2.sparkChance)
                ctx2.fillRect(opts2.cx + (this.x + x) * opts2.len + Math.random() * opts2.sparkDist * (Math.random() < .5 ? 1 : -1) - opts2.sparkSize / 2, opts2.cy + (this.y + y) * opts2.len + Math.random() * opts2.sparkDist * (Math.random() < .5 ? 1 : -1) - opts2.sparkSize / 2, opts2.sparkSize, opts2.sparkSize)
        }
        loop2();
        ...
        function loop3() {
            ...
            lines3.map(line => { return line.step(); });
        }
        function Line3() {
            this.reset();
        }
        ...
        Line3.prototype.reset = function () {
            ...
            this.lightInputMultiplier = opts3.baseLightInputMultiplier + opts3.addedLightInputMultiplier * Math.random();
        ...
        Line3.prototype.beginPhase = function () {
            ...
            this.rad += baseRad3 * (Math.random() < .5 ? 1 : -1);
            this.addedX = Math.cos(this.rad);
            this.addedY = Math.sin(this.rad);

            if (Math.random() < opts3.dieChance || this.x > dieX3 || this.x < -dieX3 || this.y > dieY3 || this.y < -dieY3)
                this.reset();
        }
        ...
        Line3.prototype.step = function () {
            ...
            ctx3.fillStyle = ctx3.shadowColor = this.color.replace('light', opts3.baseLight + opts3.addedLight * Math.sin(this.cumulativeTime * this.lightInputMultiplier));
            ctx3.fillRect(opts3.cx + (this.x + x) * opts3.len, opts3.cy + (this.y + y) * opts3.len, 2, 2);

            if (Math.random() < opts3.sparkChance)
                ctx3.fillRect(opts3.cx + (this.x + x) * opts3.len + Math.random() * opts3.sparkDist * (Math.random() < .5 ? 1 : -1) - opts3.sparkSize / 2, opts3.cy + (this.y + y) * opts3.len + Math.random() * opts3.sparkDist * (Math.random() < .5 ? 1 : -1) - opts3.sparkSize / 2, opts3.sparkSize, opts3.sparkSize)
        }
        loop3();
