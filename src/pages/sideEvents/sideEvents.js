...
const EventsInfo = data.map(event =>
  <div className="content-sde bg-white bg-opacity-0 rounded-lg shadow-2xl md:flex">
    <img src={event.img} alt="Laptop on Desk" className="abcd md:w-1/3 rounded-t-lg md:rounded-l-lg md:rounded-t-none h-[180px]" />
    <div className="p-6">
