...
export default function SideEvents() {
  ...
  const EventsInfo = data.map(event =>
    <div className="content-sde bg-white bg-opacity-0 rounded-lg shadow-2xl">
      <img src={event.img} alt="Laptop on Desk" className="side-event-img md:w-1/3 rounded-t-lg md:rounded-l-lg md:rounded-t-none h-[180px]" />
      <div className="p-6">
  ...
  return (
    <div className="side-events-container pt-12 pb-12 bg-black ">
