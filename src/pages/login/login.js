...
const Login = () => {
  ...
  function confirmPassword(event) {
    if (signUpDetails.password !== event.target.value) {
      ...
      let confirmPasswordBox =
        document.getElementsByClassName("confirm_password");
      ...
      <div class="body-lg">
        <div class="main-lg">
          ...
          <div class="signup">
            ...
            >
              <label className="label-lg" htmlFor="chk-lg" aria-hidden="true">
                Sign up
              </label>
              <input
                className="input-lg"
                ...
                required
                onChange={(event) => handleInputFields(event, true)}
              ...
              />
              <input
                className="input-lg confirm_password"
                type="password"
          ...
          <div class="login">
            <form onSubmit={(event) => handleSubmit(event, false)}>
              ...
              <input
                ...
                placeholder="Email"
                required
                onChange={(event) => handleInputFields(event, false)}
